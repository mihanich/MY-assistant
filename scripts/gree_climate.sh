...
node index.js --hvac-host="192.168.2.131" --mqtt-broker-url="mqtt://localhost" --mqtt-topic-prefix="home/greehvac" --mqtt-username="homeassistant" --mqtt-password="H0me12345"
